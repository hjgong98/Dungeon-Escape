class Play extends Phaser.Scene {
  ...
  createLeftHalf() {
    ...
    this.add.text(100, 375, `HP: ${gameState.player.hp}/${gameState.player.maxHP}`, {
      fontSize: '16px',
      fill: '#f00'
    }).setOrigin(0.5)
  ...
  startNameEditing() {
    ...
    // store elements
    this.nameEditElements = [promptBg, promptText, inputBg, this.nameInputText, saveNameBtn, cancelBtn]
